...
from ExerciseAiTrainer import Exercise, relevant_landmarks_indices, count_repetition_squat, count_repetition_bicep_curl, count_repetition_push_up, count_repetition_shoulder_press
